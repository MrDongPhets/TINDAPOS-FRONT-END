...
import { Plus, Loader2, Folder, FolderOpen, Archive, Tag, Layers, Coffee, Wine, Utensils, Apple, Leaf, Fish, Package, Sparkles, Heart, Snowflake, Flame, Droplets, ShoppingBag, Baby, Shirt, Pill, Beef, IceCream } from "lucide-react"
